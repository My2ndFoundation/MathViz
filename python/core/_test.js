'use strict';
/* 15 行级别的断言 harness——python 子项目不引入任何测试框架（Global Constraint 1）。
   语义与 chess / cryptography 的同名文件同源，但去掉了那边为解释器 BigInt 与 THROWS_AUDIT
...
/* JSON.stringify 把 Infinity、-Infinity、NaN、null 一律写成 "null"，于是一条
   ...
   那条断言唯一要防的事，而它看不见。cryptography 建项目时当场复现过：删掉守卫，
   断言照样通过。
