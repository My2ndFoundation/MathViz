  ...
  const BODY = [
    ...
    '',
    {
      ...
      en: [
        ...
        '   looking for a seat — without clearing, a column segment asked last pass would never',
        '   be asked again; asking one twice on the same pass sends the search round in circles. */',
      ],
    },
    'const asked = [];',
    ...
    '',
    {
      ...
      en: [
        ...
        '                goes off to find a column segment of its own (that is the recursion). If it',
        '                moves, this column segment frees up — that rook steps down, mine steps up.',
        '',
        '   That pass-two chain (I want this column segment → its holder moves away → that frees a',
        '   seat → ...) is, on the board, a path alternating **one row segment, one column segment**.',
        '   Its name is an augmenting path: walk one and exactly one more rook stands (the ones in',
    ...
    '    if (asked[c] === 1) {',
    {
      ...
      en: [
        '      mark(s, "cut");       // column segment already asked this pass; asking again loops',
      ],
    },
    '    } else {',
    {
    ...
    '      if (walk(takenBy[c])) {',
    {
      ...
      en: [
        '        /* The row segment holding this column segment moved away, and it already has',
        '           its own rook standing somewhere else. So the rook here steps down, mine steps up.',
    ...
    '  }',
    {
      ...
      en: [
        '  return false;             // all column segments tried — this row segment sits out this pass',
      ],
    },
    '}',
    '',
